...
aws ssm get-parameter --name "/terrapilot/KubeState Recovery Lab API/dev/kubernetes/join-command/public" --with-decryption --region "us-east-1" --query Parameter.Value --output text
```
